...
import { VideoDialog, ManualBookDialog } from '.';

export const VrViewYoutubeBasePanel = (props) => {

  const { vrMallId, videoData, videoImage } = props;
  ...
  return (
    ...
    <div id="youtubeBasePanel" className='vrview-container' style={{ width: '100%', height: '40px', backgroundColor: '#FBC200', position: 'absolute', top: 0, left: 0 }}>
      ...
      <Row type='flex' justify='center' style={{padding:'0px', width:'100%', height:'100%'}}>
        <Col span={24} style={{ paddingLeft: '10px', paddingTop: '10px', height: '40px' }}>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a style={{ color: '#1b1c14', fontWeight: 'bold'}} onClick={e => setVisibleVideoConfirm(true)}>
             동영상 설명서
          </a>
        </Col>
        <VideoDialog
