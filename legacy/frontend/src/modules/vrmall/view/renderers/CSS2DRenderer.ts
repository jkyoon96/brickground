...
export default class CSS2DRenderer {
  ...
  private getDistanceToSquaredA = new THREE.Vector3();
  private getDistanceToSquaredB = new THREE.Vector3();

  constructor() {
    this.domElement.style.overflow = 'hidden';
  }

  public zOrder(scene: THREE.Scene) {
  ...
  public getDistanceToSquared(object1: THREE.Object3D, object2: THREE.Object3D) {
  ...
  private renderObject(object: THREE.Object3D, camera: THREE.Camera) {
    if (object instanceof CSS2DObject) {
