...
export const PixelEditorDialog = (props) => {
  ...
  const handleRowCount = (count) => {
    ...
    if((columnCount * count) > 10000) {
      InfoModal('warning', '알림', '10000 Dot 이상입니다. 10000 Dot 이하로 재설정 해주세요.');
      return;
    }
  ...
  const handleColumnCount = (count) => {
    ...
    if((rowCount * count) > 10000) {
      InfoModal('warning', '알림', '' + (rowCount * count) + ' Dot 입니다.  10000 Dot 이하로 재설정 해주세요.');
      return;
    }
...
*/
  ...
  const uploadCoverImage = () => {
    ...
    var file = $("#uploadCoverImageFile")[0].files[0];
      ...
      console.log("uploadImage Start1.");
    ...
    reader.onload = function () {
      ...
      console.log("uploadImage Start2.");
      ...
      <Row type="flex" align="middle">
        ...
        <Col span={8} style={{backgroundColor: '#ffffff', height: '40px'}}>
          <Select value={rowCount} style={{ height: '40px', width: '100px' }} onChange={value => handleRowCount(value)}>
            ...
            <Option value={112}>112 dot </Option>
            <Option value={128}>128 dot </Option>
            <Option value={144}>144 dot </Option>
            <Option value={160}>160 dot </Option>
          </Select>
        </Col>
        <Col span={4} style={{paddingLeft: '10px', fontWeight: 'bold'}}>
          세로
