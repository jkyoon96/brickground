...
*/
  ...
  */
  ...
  const initVrControls = () => {
    ...
    console.log('optimizeMode : ' + optimizeMode);
    ...
    console.log(" navigator.platform.toLowerCase() : " + navigator.platform.toLowerCase())
    console.log('optimizeMode : ' + optimizeMode);
     ...
     gltfLoader.load( './images/brickground/models/41314/4161734.glb', function ( object:any ) {
       ...
       for (i = 0; i < dotrow ; i++) {
         for(j = 0; j < dotcol; j ++) {
           ...
           let dotAsset;
           if(optimizeMode)
             dotAsset = tempObject.clone();
           else
             dotAsset = object.scene.clone();
       ...
       if(vrModels != undefined) {
         ...
         if(vrModels.instances != undefined) {
           ...
           vrModels.instances.forEach(instance => {
             ...
             if(asset != undefined) {
               //console.log("dotName : " + instance.instanceName + " , color : " + instance.color + " , colorId : " + instance.colorId);
