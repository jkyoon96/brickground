...
import { ProductListView, ProductView, ProductDotView, ProductSetListView, ProductSetInfo, CartView, PaymentView, PaymentResultView } from 'modules/productlist/view';
...
import { DotArtListView, DotArtEditorView, DotArtView, DotArtCommunityView } from 'modules/dotart/view';
import { TermsOfService, Privacy } from 'modules/policy';
import { LoginView, AccountView, MyVrMallListView, MyPageView, PasswordResetView, PasswordChangeView } from 'modules/user/view';
import { HelpCenterView } from 'modules/help/view';

//export const SOPOONG_URL = 'http://localhost';
export const SOPOONG_URL = 'http://210.115.229.12:8030';
  ...
  return (
    <Router >
      <Analytics id='UA-172718993-1' debug>
          <Switch>
            <NomalLayout>
              <Route exact path={ROOT_PATH} component={DotArtListView}  />
              <Route exact path={SHOP_URL} component={MainView}  />
              <Route exact path={SHOP_URL_INDEX} component={MainView} />
              <Route exact path={MAIN_PATH} component={DotArtListView}  />
